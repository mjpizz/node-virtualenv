...
function VirtualEnv(packagePath, options) {
  ...
  this._expectedHash = this._createVirtualenvHash(package, this._requirements);
...
VirtualEnv.prototype._createVirtualenvHash = function _createVirtualenvHash(package, requirements) {
